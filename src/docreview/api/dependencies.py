"""Explicit application dependencies for HTTP route adapters."""
...
class CompatibilityScope:
    """Server-owned scope for Go-compatible routes that do not authenticate callers."""

    workspace_id: str

    def __post_init__(self) -> None:
        if not self.workspace_id.strip():
            raise ValueError("compatibility workspace scope is required")
